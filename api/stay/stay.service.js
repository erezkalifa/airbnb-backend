...
function _buildCriteria(filterBy) {
    ...
    if (filterBy.minPrice !== undefined || filterBy.maxPrice !== undefined) {
        criteria.price = {}
        if (filterBy.minPrice !== undefined) criteria.price.$gte = +filterBy.minPrice
        if (filterBy.maxPrice !== undefined) criteria.price.$lte = +filterBy.maxPrice
    }
...
function _buildSort(filterBy) {
    ...
    if (!filterBy.sortField || !validFields.includes(filterBy.sortField)) return {}
